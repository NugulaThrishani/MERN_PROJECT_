  ...
  const renderOverview = () => (
    <div className="space-y-6">
      ...
      <motion.div
        ...
        className="bg-gradient-to-br from-blue-600 via-purple-600 to-green-600 rounded-xl p-6 text-white"
      >
    ...
    <div className="space-y-6">
      <div className="grid md:grid-cols-3 gap-6">
        <motion.div
          initial={{ opacity: 0, y: 20 }}
          animate={{ opacity: 1, y: 0 }}
          className="bg-gradient-to-br from-yellow-500 to-orange-600 p-6 rounded-xl text-white"
        >
          ...
          <div className="grid grid-cols-2 gap-4">
            {[
              ...
              <motion.div
                key={index}
                whileHover={{ scale: 1.05 }}
                className={`p-4 rounded-lg border-2 ${badge.earned ? 'border-transparent' : 'border-dashed border-gray-300'}`}
                style={badge.earned ? {
